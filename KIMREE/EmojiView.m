...
- (void)drawRect:(CGRect)rect
{
    ...
    back.frame = CGRectMake(275, 147, 38, 28);
    [self addSubview:back];
   
}

#pragma mark -
- (void)backFace{//点击了删除按钮
    if ([self.delegate respondsToSelector:@selector(selectedDel:)]) {
        [self.delegate selectedDel:_symbolArray];
    }
}
